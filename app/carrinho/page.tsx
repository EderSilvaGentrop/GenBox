...
// Função de segurança para evitar o erro "NaN" na exibição e no rastreio
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-8 space-y-4">
              {carrinho.map((item) => {
                ...
                return (
                  /* DIV PRINCIPAL DO ITEM - CONFIGURADA PARA O MCP */
                  <div 
                    key={item.id} 
                    data-product-id={item.id}   // ID real para o Sitemap
                    data-price={precoUnitario}  // Preço limpo para o Sitemap
                    data-quantity={item.quantidade} 
                    className="bg-white p-6 rounded-[2rem] border border-black flex items-center gap-6 group hover:shadow-md transition-all"
                  >
                    {/* Imagem do Produto */}
                    ...
                    <div className="text-right flex flex-col items-end gap-3">
                      ...
                      <button 
                        ...
                        title="Remover item"
                        data-remove-id={item.id} // Identificador extra para o listener
                      >
                        <Trash2 size={22} />
                      </button>
                    </div>
